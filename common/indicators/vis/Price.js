        ...
        vis_update: function(d3, vis, options) {
            ...
            var wick = this.wicks.selectAll('line.wick')
              .data(vis.data, function(d) {return d.key})
                .attr('x1', function(d, i) {return i * (vis.chart.setup.bar_width + vis.chart.setup.bar_padding) + Math.floor((vis.chart.setup.bar_width) / 2) + (options.wickoffset * vis.chart.setup.bar_width || 0)})
                .attr('x2', function(d, i) {return i * (vis.chart.setup.bar_width + vis.chart.setup.bar_padding) + Math.floor((vis.chart.setup.bar_width) / 2) + (options.wickoffset * vis.chart.setup.bar_width || 0)})
