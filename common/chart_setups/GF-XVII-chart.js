define({
	...
	components: [
		...
		{   
            ...
            height: 400,
            indicators: {
                "volvol": {def:["pri.ask.volume,atr9", "vis:VolVol"], vol_thres: 300, atr_thres: 4, thres_dist: 20},
                ...
                "lreg34regr_clr": {def:["lreg34", "vis:SlopeColorLine"], threshold: 0.00005, width: 6, opacity: 0.7},
        ...
        // Top Matrix
        {
            ...
            indicators: {
                ...
                "hook_rsi4": {def:["rsi4", "dir:Hooks"], name:"RSI4_HK"},
