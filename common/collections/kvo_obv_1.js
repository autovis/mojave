define({
    ...
    "ask":                   ["0",                              "stream:AskBar"],
    "bid":                   ["0",                              "stream:BidBar"],
    "avg":                   ["ask,bid",                        "stream:BarAvg"],
    "m30":                   [{tf:"m30"}, "avg",                "tf:Candle2Candle"],

    // Indicator definitions
    "cci14":                  [["avg", "price:typical"],         "njtr:CCI", 14],
    "atr":                    ["avg",                            "ATR", 9],
    "sdl_s":                  ["avg.close",                      "SDL", 89],
    "sdl_f":                  ["avg.close",                      "SDL", 5],
    "rsi":                    ["avg.close",                      "RSI", 4],
    "srsi_m":                 ["avg.close",                      "StochRSI", 14, 14, 5, 3],
    "srsi_f":                 ["avg.close",                      "StochRSI", 3, 3, 3, 2],
