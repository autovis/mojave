    ...
    init: function(callback) {
        ...
        async.series([
            ...
            function(cb) {
                ...
                vis.indicators = _.filter(vis.data, function(inp) {return inp.category == "indicator" || inp.category === undefined});
                vis.hashtable = {};
    ...
    render: function() {
        ...
        function plot_indicators() {
            ...
            var out_lead = indsym.append("g")
                .attr("class", "out_lead")
                .attr("transform", function(d,i) {return "translate("+(d.width+vis.config.indicators.nose_len+3)+","+Math.round(d.height/2)+")"})
